...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AssetId', 'model/CustomerId', 'model/TenantId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AssetId'), require('./CustomerId'), require('./TenantId'));
  } else {
    // Browser globals (root is window)
    if (!root.ThingsboardRestApi) {
      root.ThingsboardRestApi = {};
    }
    root.ThingsboardRestApi.Asset = factory(root.ThingsboardRestApi.ApiClient, root.ThingsboardRestApi.AssetId, root.ThingsboardRestApi.CustomerId, root.ThingsboardRestApi.TenantId);
  }
}(this, function(ApiClient, AssetId, CustomerId, TenantId) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('id')) {
        obj['id'] = AssetId.constructFromObject(data['id']);
      }
  ...
  /**
   * @member {module:model/AssetId} id
   */
